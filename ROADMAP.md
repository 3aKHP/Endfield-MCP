...
- TypeScript: `0.4.0-dev.0` — in development (v0.4 target: Worldbuilding — in-game PRTS documents & wiki entries). Latest release: `0.3.3` (hotfix — server version now read from package.json instead of a drifting literal; v0.3.2's `SERVER_VERSION` was stuck at 0.3.1).
